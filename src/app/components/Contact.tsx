      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <a 
              href="mailto:youssef.tounekti@exemple.com"
              className="group bg-slate-900 rounded-xl p-8 hover:bg-slate-700 transition-all duration-300 transform hover:scale-105 border border-slate-700 hover:border-cyan-500"
            >
              ...
              <p className="text-cyan-400 font-medium">youssef.tounekti@exemple.com</p>
            </a>
            ...
            >
              ...
              <p className="text-cyan-400 font-medium">+33 1 23 45 67 89</p>
            </a>
          </div>
          
          <div className="flex justify-center gap-6">
            <a 
              href="https://github.com/yousseftounekti"
              target="_blank"
            ...
            <a 
              href="https://linkedin.com/in/youssef-tounekti"
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-slate-900 p-4 rounded-full hover:bg-slate-700 transition-all duration-300 transform hover:scale-110 border border-slate-700 hover:border-cyan-500"
            >
            ...
            <a 
              href="https://twitter.com/yousseftounekti"
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-slate-900 p-4 rounded-full hover:bg-slate-700 transition-all duration-300 transform hover:scale-110 border border-slate-700 hover:border-cyan-500"
            >
